module.exports = function(mysql, config){
	...
	rwk.rwkID.member.get = function create(req, res, next) {
		var query = {
	...
	rwk.rwkID.member.post = function create(req, res, next) {
	...
	rwk.rwkID.member.shotInID.get = function create(req, res, next) {
	...
	// edit memberIn
	rwk.rwkID.member.shotInID.post = function create(req, res, next) {
		mysql.query(
			"UPDATE shotIn " +
	...
	// delete memberIn
	rwk.rwkID.member.shotInID.del = function create(req, res, next) {
		mysql.query(
			"DELETE FROM shotIn " +
			"WHERE shotIn.id = ?; ",
			[req.params.shotInID],
