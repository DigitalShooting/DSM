module.exports = function(mysql){
	...
	manschaft.manschaftID.member.get = function create(req, res) {
		...
		mysql.query(
			"SELECT memberIn.id, memberIn.stamm, memberIn.userID, memberIn.manschaftID, user.firstName as 'firstName', user.lastName as 'lastName', verein.name as 'verein', manschaft.name as 'manschaft' " +
			"FROM memberIn " +
			"LEFT JOIN user ON user.id = memberIn.userID " +
			"LEFT JOIN verein ON user.vereinID = verein.id " +
			"LEFT JOIN manschaft ON memberIn.manschaftID = manschaft.id " +
