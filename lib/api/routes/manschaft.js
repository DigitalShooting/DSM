module.exports = function(mysql, config){
	...
	manschaft.manschaftID.get = function create(req, res, next) {
	...
	// edit manschaft
	manschaft.manschaftID.post = function create(req, res, next) {
		mysql.query(
			"UPDATE manschaft " +
	...
	// delete manschaft
	manschaft.manschaftID.del = function create(req, res, next) {
		mysql.query(
	...
	manschaft.manschaftID.member.get = function create(req, res, next) {
		var query = {
	...
	manschaft.manschaftID.member.post = function create(req, res, next) {
		mysql.query(
	...
	manschaft.manschaftID.member.memberID.get = function create(req, res, next) {
	...
	// edit memberIn
	manschaft.manschaftID.member.memberID.post = function create(req, res, next) {
		mysql.query(
			"UPDATE memberIn " +
	...
	// delete memberIn
	manschaft.manschaftID.member.memberID.del = function create(req, res, next) {
		mysql.query(
			"DELETE FROM memberIn " +
			"WHERE memberIn.id = ?; ",
			[req.params.memberID],
