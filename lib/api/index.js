...
server.get('/memberIn/rwk/:rwkID', routes.memberIn.rwk.id.get);
server.post('/memberIn/rwk/:rwkID', routes.memberIn.rwk.id.post);

// server.get('/memberIn/:id/rwk/:rwkID', routes.memberIn.id.rwk.id.get);
// server.post('/memberIn/:id/rwk/:rwkID', routes.memberIn.id.rwk.id.post);
// server.del('/memberIn/:id/rwk/:rwkID', routes.memberIn.id.rwk.id.del);
